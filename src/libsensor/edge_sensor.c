...
/**
 * @brief Print the information of EdgeInfo structure for debugging.
 * @param[in] info The pointer of EdgeInfo structure.
 */
static void
show_edge_info (EdgeInfo *info)
{
  debug_print("\nmqtt_host_address: %s\n"
              "mqtt_host_port: %s\n"
              "mqtt_client_id: %s\n"
              "mqtt_topic: %s\n"
              "mqtt_msg_buf_size: %lu\n"
              "  base_time_epoch: %ld\n"
              "  sent_time_epoch: %ld\n"
              "  duration: %lu\n"
              "  dts: %lu\n"
              "  pts: %lu\n",
              info->mqtt_host_address, info->mqtt_host_port,
              info->mqtt_client_id, info->mqtt_topic,
              info->mqtt_msg_buf_size,
              info->mqtt_msg_hdr.base_time_epoch,
              info->mqtt_msg_hdr.sent_time_epoch,
              info->mqtt_msg_hdr.duration,
              info->mqtt_msg_hdr.dts,
